...
/// @brief True if the bluetooth is power on
@property (atomic, readonly) BOOL isPowerOn;
...
/*!
 @brief Retrieve peripheral from UUID

 @param identifier UUID
 @return CBPeripheral or nil if no found.
 */
